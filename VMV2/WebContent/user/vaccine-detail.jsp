				...
				<div class="content-page">
					...
					<div class="row" style="padding: 10px;">
						...
						<div class="col-md-8" style="padding-left: 30px;">
							<h5><b>Chỉ định:</b></h5>
							<p>PriorixTM được chỉ định để gây miễn dịch chủ động chống sởi, quai bị và rubella.</p>
							<br>
							<h5><b>Số mũi:</b></h5>
							<p>1</p>
							<br>
							<h5><b>Liều lượng và cách sử dụng:</b></h5>
							<p>Liều đề nghị là một liều 0,5 ml vaccine hoàn nguyên. Lịch tiêm chủng ở mỗi nước một khác, do vậy nên theo lịch tiêm chủng được khuyến cáo ở quốc gia đó. Cách dùng: PriorixTM nên tiêm dưới da mặc dù có thể dùng để tiêm bắp.</p>
							<br>
							...
							<p>Không nên dùng PriorixTM cho những người suy giảm đáp ứng miễn dịch, bao gồm những bệnh nhân suy giảm miễn dịch tiên phát hoặc thứ phát. Tuy nhiên, có thể dùng vaccine kết hợp sởi, quai bị và rubella cho những người nhiễm HIV không triệu chứng mà không gây những ảnh hưởng bất lợi đến tình trạng bệnh của họ và có thể cân nhắc sử dụng cho những người nhiễm HIV có triệu chứng.</p>
							<br>
							<h5><b>Tác dụng phụ:</b></h5>
							<p>Rất phổ biến: đỏ tại chỗ tiêm, sốt ≥ 38oC (trực tràng), hoặc ≥ 37.5oC (nách/miệng) Phổ biến: sưng và đau tại chỗ tiêm, sốt > 39.5oC (trực tràng) hay > 39oC (nách/miệng). Nhìn chung, phân loại tần suất các tác dụng phụ là tương tự như nhau khi tiêm liều đầu tiên hoặc liều thứ hai vaccine. Chỉ có một khác biệt là tác dụng phụ đau tại chỗ tiêm là “Phổ biến” sau khi tiêm liều đầu tiên và “Rất phổ biến” sau khi tiêm liều thứ hai.</p>
						</div>
					</div>
				</div>
			</div>
